...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Data Kerja Sama</h1>
    </div>
    ...
    <div class="table-responsive col-lg-9">
        <a href="/dashboard/sponsors/create" class="btn btn-sm btn-primary mb-3">Tambah Sponsor Baru</a>
        <table class="table table-striped table-sm">
          ...
          @if ($sponsors->count())
            ...
            <tr>
                ...
                <td><img src="{{ asset('storage/'.$sponsor->foto) }}" style="width: 70px;" alt="{{ $sponsor->nama }}"></td>
                <td>
                  @if ($sponsor->status == 0)
                ...
                <td>
                  @if ($sponsor->status == "1")
                    <form action="/dashboard/sponsors/status/{{ $sponsor->id }}" method="post" class="d-inline">
                  ...
                  @endif
                    {{-- <a href="/dashboard/sponsors/{{ $sponsor->slug }}" class="badge bg-info"><i class="fas fa-eye"></i></a> --}}
                    <a href="/dashboard/sponsors/{{ $sponsor->id }}" class="badge bg-warning" title="ubah data"><i class="fas fa-edit"></i></a>
                    <form action="/dashboard/sponsors/delete/{{ $sponsor->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
